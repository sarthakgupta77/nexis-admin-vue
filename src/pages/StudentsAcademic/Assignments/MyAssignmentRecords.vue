      ...
      <div class="row">
        <div class="col-md-12">
          <div class="head-btn-box shadowBoder">
            <div class="row">
              <h5 class="q-ma-none q-pt-xs" id="head-1">My Assignment Records</h5>
            </div>
          </div>
            ...
            <q-card class="modal-card">
              <q-card-section class="q-pa-none">
                <div class="row q-pa-md create-header">
                  <span class="text-h6 w600">Assignment Scores</span>
                ...
                <div class="q-pa-md">
                  ...
                  <div class="row" v-for="marks in data.marks" :key="marks.id">
                    ...
                    <div class="col-2 q-pl-sm scoring">
                      <q-input dense square filled class="category-name" v-model="marks.obtained_marks" disable></q-input>
                    </div>
                  </div>
                </div>
              </q-card-section>
                ...
                <table id="dtBasicExample" class="table table-striped table-bordered table-sm" cellspacing="0"
                  ...
                  <tbody>
                    <tr v-for="project in data.allEvaluatedRecords">
                      ...
                      <td> <b> Name :</b> {{ project.name }} <br><b> Email :</b> {{ project.email }}
                      </td>
                      ...
                      <td>
                        <div v-if="project.submission == 0" class="badge-btn">
                          <b>Submission :</b> <q-chip color="red-5" size="12px" class="text-center" text-color="white">
                            Not Submitted
                          </q-chip>
                          <br />
                        </div>
                        <div v-else-if="project.submission == 1" class="badge-btn">
                          <b>Submission :</b> <q-chip color="indigo" size="12px" class="text-center" text-color="white">
                            Submitted
                          </q-chip>
                          <br>
                        </div>
                        <div v-if="project.published == 1" class="badge-btn">
                          <b>Status :</b> <q-chip color="green" class="text-center" size="12px" text-color="white">
                            Published
                          </q-chip>
                        </div>
                        <div v-if="project.published == 0">
                          <b>Status :</b> <q-chip color="red" class="text-center" size="12px" text-color="white">
                            UnPublished
                          </q-chip>
                        </div>
                      </td>
