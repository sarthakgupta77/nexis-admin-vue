        ...
        <div class="col-md-12">
          <div class="head-btn-box shadowBoder">
            <q-btn flat round color="white" text-color="positive" class="q-mr-sm" icon="arrow_back" id="back-btn"
              to="/assignment/my-assigned">
              <q-tooltip anchor="top start" self="center left" :offset="[10, 15]" transition-show="scale"
                transition-hide="scale">
                Back to My Assigned Assignments
              </q-tooltip>
            </q-btn>
            <h5 class="q-ma-none" id="head-1">Assigned Assignment Details</h5>
          </div>
          <div class="row">
            <div class="col-6 q-pr-sm">
              <div class="shadowBoder" style="height: 100vh; overflow-y:scroll">
                <div class="row q-py-md">
                  ...
                  <div class="col-12 row q-py-sm" style="align-items:center; justify-content: space-between;">
                    <span class="text-subtitle1 col-9">
                      <b>
                        Submission Date & Time :</b> {{ data.project.submission_date }}
                    </span>
                      <q-chip v-if="data.project.submission === 1" color="indigo" style="width: 15%" class="text-center" text-color="white">
                        Submitted
                      </q-chip>
                      <q-chip v-else color="red-5" style="width: 19%" class="text-center" text-color="white">
                        Not Submitted
                      </q-chip>
                  </div>
                  <div class="col-12 row q-py-sm">
              ...
              <div class="shadowBoder">
                ...
                <q-tab-panels v-model="message_tab">
                  ...
                  <q-tab-panel name="msg2">
                    <h6 class="q-ma-none q-pa-sm"> Assignment Scoring Parameters</h6>
                    <div class="q-pa-md">
...
onBeforeMount(() => {
  api.get("get-project", {
    params: { project_id: route.params.id, student_id: route.params.student_id, is_project: 0 }
  }).then((response) => {
