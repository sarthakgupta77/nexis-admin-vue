      ...
      <div class="row">
        <div class="col-md-12">
          <div class="head-btn-box shadowBoder">
            ...
            <h5 class="q-ma-none" id="head-1">Assingment Details</h5>
          </div>
          <div class="col-12 ProjectDetails d-flex">
            <div class="projectBox shadowBoder q-mr-sm">
              ...
              <div class="row" style="align-items:center">
                <div class="col-10">
                  <h6 class="q-ma-none q-py-lg"> {{ data.assignment.title }} - Details</h6>
                </div>
                <div class="col-2">
                  <div v-if="data.assignment.type == 1">
                    <q-chip color="green-5" text-color="white">
                      Evaluation
                    </q-chip>
                    <br />
                  </div>
                  <div v-else-if="data.assignment.type == 0">
                  ...
                  <div v-else-if="data.assignment.type == 2">
              ...
              <div class="q-py-md text-subtitle1">
                <b>Course: </b> {{ data.assignment.course }}
              </div>
              <div class="col-12">
                <p v-html="data.assignment.description"></p>
              </div>
            </div>
