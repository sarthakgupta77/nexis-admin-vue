        ...
        <div class="col-md-12">
          <div class="head-btn-box row shadowBoder">
            <div class="row col-5">
              ...
              <h5 class="q-ma-none q-pt-xs" id="head-1">Edit project</h5>
            </div>
            <div class="row">
              <q-btn class="create-btn col-12" @click="updateProject" label="Update Project"></q-btn>
            </div>
            ...
            <div class="projectBox  q-mr-sm">
              ...
              <div class="row q-pa-md">
                <div class="col-md-12 q-pr-sm">
                  ...
                  <q-input dense outlined color="secondary" v-model="data.project.title" class="col-md-12 " lazy-rules
                ...
                <div class="col-8 q-pr-sm">
                  ...
                  <q-select dense outlined :options="courseOptions" emit-value map-options color="secondary"
                    v-model="data.project.course" class="col-md-12 " />
                </div>
                <div class="col-4 q-pr-sm">
                  ...
                  <q-select dense outlined :options="typeOptions" emit-value map-options color="secondary"
                    v-model="data.project.type" class="col-md-12 " />
                </div>
                <div>
                </div>
                ...
                <div class="col-12">
                  <div class="row ">
                    ...
                    <q-editor v-model="data.project.description" :dense="$q.screen.lt.md" class="col-12 descriptionScroll" :toolbar="[
                      [
                        {
...
const updateProject = () => {
  ...
  data.FormData.append("project_id", data.project.id),
  data.FormData.append("is_project", 1),
  data.FormData.append("title", data.project.title)
  data.FormData.append("type", data.project.type)
  data.FormData.append("course", data.project.course)
  data.FormData.append("description", data.project.description)
