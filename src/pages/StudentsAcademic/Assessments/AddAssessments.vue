<template>
    ...
    <div class="container">
      <div class="heading">
        <div class="head-btn-box shadowBoder">
          ...
          <h5 class="q-ma-none" id="head-1">Create New Assessment</h5>
        </div>
      </div>
            ...
            <q-card-section class="q-pa-sm row">
              <div class="row col-12">
                <div class="col-md-4 row q-px-sm">
                  ...
                  <q-input dense outlined color="secondary" v-model="Assessment.title" class="col-md-12 " lazy-rules
                ...
                <div class="col-md-4 row q-px-sm">
                  ...
                  <q-select dense outlined color="secondary" v-model="Assessment.course_name" :options="courseOptions"
                ...
                <div class="col-md-4 row q-px-sm">
                  ...
                  <q-select dense outlined color="secondary" v-model="Assessment.type" :options="types" class="col-md-12 "
                    lazy-rules emit-value map-options
              ...
              <div class="col-12 row">
                <div class="col-md-3 row q-px-sm">
                  ...
                  <q-input dense outlined color="secondary" type="number" v-model="Assessment.attempts" class="col-md-12 "
                    lazy-rules
                ...
                <div class="col-md-3 row q-px-sm">
                  ...
                  <q-select dense outlined color="secondary" v-model="Assessment.certificate"
                ...
                <div class="col-md-3 row q-px-sm">
                  ...
                  <q-input dense outlined type="number" color="secondary" v-model="Assessment.duration" class="col-md-12 "
                    lazy-rules :rules="[val => val !== '' || 'Please Enter Duration of Assessment']" />
                </div>
                <div class="col-md-3 row q-px-sm">
                  <label class="col-md-12 q-pa-xs" style="font-weight: 600">
                    Max Marks
                  </label>
                  <q-input dense type="number" outlined color="secondary" v-model="Assessment.max_marks"
              ...
              <div class="col-12 q-pa-sm">
                <div class="row ">
                  ...
                  <q-editor v-model="Assessment.instructions" :dense="$q.screen.lt.md" class="col-12" :toolbar="[
                    [
                      {
  ...
  verdana: 'Verdana'
          ...
          <template v-if="questionsArea">
                    ...
                    <template v-if="questions.type == 'objective'">
                      <div class="col-12 q-py-md row" v-for="options in questions.mcqAnswers" :key="options.id">
                        <div class="col-12 row" style="justify-content: center;">
                          ...
                          <q-input dense borderless v-model="options.value" class="col-11 q-px-md bg-grey-3 text-black" />
                        </div>
                      </div>
                    </template>
            ...
            <div class="create-event-btn q-py-md">
              ...
              <q-btn class="submit-btn" @click="createAssessment" label="Create Assessment" />
            </div>
          </template>
        </div>
      </div>
